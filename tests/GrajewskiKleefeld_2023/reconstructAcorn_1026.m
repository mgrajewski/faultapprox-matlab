% Reconstruction of the acorn in "Detecting and approximating decision
...
filename = 'farFieldData1026/farFieldAcorn.txt';
resultfile = 'raw_results/pointsAcorn.txt';
normalsfile = 'raw_results/normalsAcorn.txt';
statsfile = 'raw_results/acorn1026.csv';
