...
% dimensional spaces", section 4.1, Test problem 4.3

% Author: Matthias Grajewski (grajewski@fh-aachen.de)
% This file is part of faultapprox-matlab
% (https://github.com/mgrajewski/faultapprox-matlab)
statsfile = 'testCasePaper2D_4.3_stats.csv';
...
MyProb = ProblemDescr;
MyProb.OutputFileVTU = 'raw_results/testCase2D_4.3.vtu';
MyProb.Testfunc = @testFunc2D_4_3;
...
writelines('testCase2D_4.3', statsfile, WriteMode='overwrite')
