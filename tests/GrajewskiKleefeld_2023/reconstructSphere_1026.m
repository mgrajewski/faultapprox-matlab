% Reconstruction of the sphere in "Detecting and approximating decision
...
filename = 'farFieldData1026/farFieldSphere.txt';
resultfile = 'raw_results/pointsSphere.txt';
normalsfile = 'raw_results/normalsSphere.txt';
statsfile = 'raw_results/sphere1026.csv';
