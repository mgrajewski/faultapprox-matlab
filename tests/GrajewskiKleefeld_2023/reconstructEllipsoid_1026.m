% Reconstruction of the ellipsoid in "Detecting and approximating decision
% boundaries in low dimensional spaces", section 4.3
...
filename = 'farFieldData1026/farFieldEllipsoid.txt';
resultfile = 'raw_results/pointsEllipsoid.txt';
normalsfile = 'raw_results/normalsEllipsoid.txt';
statsfile = 'raw_results/ellipsoid1026.csv';
