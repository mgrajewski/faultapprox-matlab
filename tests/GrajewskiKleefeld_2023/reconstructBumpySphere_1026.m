% Reconstruction of the bumpy sphere in "Detecting and approximating
...
filename = 'farFieldData1026/farFieldBumpySphere.txt';
resultfile = 'raw_results/pointsBumpySphere.txt';
normalsfile = 'raw_results/normalsBumpySphere.txt';
statsfile = 'raw_results/bumpySphere1026.csv';
