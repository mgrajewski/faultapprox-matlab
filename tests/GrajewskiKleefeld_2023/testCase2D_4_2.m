...
% dimensional spaces", section 4.1, Test problem 4.2

% Author: Matthias Grajewski (grajewski@fh-aachen.de)
% This file is part of faultapprox-matlab
% (https://github.com/mgrajewski/faultapprox-matlab)
statsfile = 'testCasePaper2D_4.2_stats.csv';
...
MyProb = ProblemDescr;
MyProb.OutputFileVTU = 'raw_results/testCase2D_4.2.vtu';
MyProb.Testfunc = @testFunc2D_4_2;
...
writelines('testFunc2D_4_2', statsfile, WriteMode='overwrite')
