% Reconstruction of the long cylinder in "Detecting and approximating
...
filename = 'farFieldData1026/farFieldLongCylinder.txt';
resultfile = 'raw_results/pointsLongCylinder.txt';
normalsfile = 'raw_results/normalsLongCylinder.txt';
statsfile = 'raw_results/longCylinder1026.csv';
