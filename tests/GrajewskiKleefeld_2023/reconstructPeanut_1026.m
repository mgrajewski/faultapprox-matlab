% Reconstruction of the peanut in "Detecting and approximating decision
...
filename = 'farFieldData1026/farFieldPeanut.txt';
resultfile = 'raw_results/pointsPeanut.txt';
normalsfile = 'raw_results/normalsPeanut.txt';
statsfile = 'raw_results/peanut1026.csv';
