...
% dimensional spaces", section 4.1, Test problem 4.1

% Author: Matthias Grajewski (grajewski@fh-aachen.de)
% This file is part of faultapprox-matlab
% (https://github.com/mgrajewski/faultapprox-matlab)
statsfile = 'testCasePaper2D_4.1_stats.csv';
...
MyProb = ProblemDescr;
MyProb.OutputFileVTU = 'raw_results/testCase2D_4.1.vtu';
MyProb.Testfunc = @testFunc2D_4_1;
...
writelines('testFunc2D_4_1', statsfile, WriteMode='overwrite')
