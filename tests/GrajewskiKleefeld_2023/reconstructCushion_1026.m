% Reconstruction of the cushion in "Detecting and approximating decision
...
filename = 'farFieldData1026/farFieldCushion.txt';
resultfile = 'raw_results/pointsCushion.txt';
normalsfile = 'raw_results/normalsCushion.txt';
statsfile = 'raw_results/cushion1026.csv';
