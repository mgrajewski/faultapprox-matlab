% function for test case 3D_03: 2 subdomains, the subdomain 2 consists of
% two facets inside the domain. One of the facets is not parallel to any
% coordinate plane.

% Author: Matthias Grajewski (grajewski@fh-aachen.de)
% This file is part of faultapprox-matlab
% (https://github.com/mgrajewski/faultapprox-matlab)
function ClassOfPoints = testFuncFaultApprox3D_03(PointSet, ProblemDescr)
